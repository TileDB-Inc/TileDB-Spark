...
public class WriteSparkDataTypesTest extends SharedJavaSparkSession implements Serializable {
  ...
  public Dataset<Row> createByteDataset(SparkSession ss) {
    StructField[] structFields =
        new StructField[] {
          ...
          // new StructField(
          //        "a2", DataTypes.createArrayType(DataTypes.ByteType, false), false,
          // Metadata.empty()),
        };
