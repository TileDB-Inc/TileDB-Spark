...
This will create a `build/libs/TileDB-Spark-0.0.3-SNAPSHOT.jar` JAR as well as build a TileDB-Java Jar that
...
you need to specify the path to built project jar with `--jars` to upload to the Spark cluster.
    ...
    $ spark-shell --jars build/libs/TileDB-Spark-0.0.3-SNAPSHOT.jar,/path/to/TileDB-Java-0.1.7-SNAPSHOT.jar
